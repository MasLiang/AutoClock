...
/* Module Definition */
void A_IO_L3_in_m1_4(hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void A_IO_L3_in_serialize_m1_4(A_t16 *A, hls::stream<A_t16> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void A_IO_L2_in_intra_trans_m1_4(int idx, int c0, int c1, int c2, A_t16 local_A[8][1], hls::stream<A_t2> &fifo_A_local_out, bool intra_trans_en) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  A_t2 data_split[8];
...
/* Module Definition */
void A_IO_L2_in_inter_trans_m1_4(int idx, int c0, int c1, int c2, A_t16 local_A[8][1], hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_out, bool inter_trans_en) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void A_IO_L2_in_inter_trans_boundary_m1_4(int idx, int c0, int c1, int c2, A_t16 local_A[8][1], hls::stream<A_t16> &fifo_A_in, bool inter_trans_en) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void A_IO_L2_in_m1_4(int idx, hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_out, hls::stream<A_t2> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  A_t16 local_A_ping[8][1];
...
/* Module Definition */
void A_IO_L2_in_boundary_m1_4(int idx, hls::stream<A_t16> &fifo_A_in, hls::stream<A_t2> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  A_t16 local_A_ping[8][1];
    ...
    for (ap_uint<3> c0 = 0; c0 <= 3; c0 += 1)
      for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1)
        for (ap_uint<3> c2 = 0; c2 <= 3; c2 += 1) {
          ...
          {
            if (arb == 0) {
              A_IO_L2_in_inter_trans_boundary_m1_4(
                /* module id */ idx, 
                /* host iter */ c0, 
                /* host iter */ c1, 
                /* host iter */ c2, 
...
/* Module Definition */
void B_IO_L3_in_m1_4(hls::stream<B_t16> &fifo_B_in, hls::stream<B_t16> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L3_in_serialize_m1_4(B_t16 *B, hls::stream<B_t16> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L2_in_intra_trans_m1_4(int idx, int c0, int c1, int c2, B_t16 local_B[8][1], hls::stream<B_t2> &fifo_B_local_out, bool intra_trans_en) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  B_t2 data_split[8];
...
/* Module Definition */
void B_IO_L2_in_inter_trans_m1_4(int idx, int c0, int c1, int c2, B_t16 local_B[8][1], hls::stream<B_t16> &fifo_B_in, hls::stream<B_t16> &fifo_B_out, bool inter_trans_en) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L2_in_inter_trans_boundary_m1_4(int idx, int c0, int c1, int c2, B_t16 local_B[8][1], hls::stream<B_t16> &fifo_B_in, bool inter_trans_en) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L2_in_m1_4(int idx, hls::stream<B_t16> &fifo_B_in, hls::stream<B_t16> &fifo_B_out, hls::stream<B_t2> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  B_t16 local_B_ping[8][1];
...
/* Module Definition */
void B_IO_L2_in_boundary_m1_4(int idx, hls::stream<B_t16> &fifo_B_in, hls::stream<B_t2> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  B_t16 local_B_ping[8][1];
    ...
    for (ap_uint<3> c0 = 0; c0 <= 3; c0 += 1)
      for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1)
        for (ap_uint<3> c2 = 0; c2 <= 3; c2 += 1) {
          ...
          {
            if (arb == 0) {
              B_IO_L2_in_inter_trans_boundary_m1_4(
                /* module id */ idx, 
                /* host iter */ c0, 
                /* host iter */ c1, 
                /* host iter */ c2, 
...
/* Module Definition */
void PE_m1_4(int idx, int idy, hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, hls::stream<float> &fifo_C_drain_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  A_t1 local_A[1][2];
...
/* Module Definition */
void PE_wrapper_m1_4(int idx, int idy, hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, hls::stream<float> &fifo_C_drain_out)
 {
  PE_m1_4(
    /* module id */ idx, 
    /* module id */ idy, 
...
/* Module Definition */
void A_PE_dummy_in_m1_4(int idx, int idy, hls::stream<A_t2> &fifo_A_in) {
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
...
/* Module Definition */
void B_PE_dummy_in_m1_4(int idx, int idy, hls::stream<B_t2> &fifo_B_in) {
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L1_out_intra_trans_m1_4(int idx, int idy, int c0, int c1, C_t4 local_C[8][2], hls::stream<float> &fifo_C_drain_local_in) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  ap_uint<32> data_split[4];
...
/* Module Definition */
void C_drain_IO_L1_out_inter_trans_m1_4(int idx, int idy, int c0, int c1, C_t4 local_C[8][2], hls::stream<C_t4> &fifo_C_drain_in, hls::stream<C_t4> &fifo_C_drain_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L1_out_inter_trans_boundary_m1_4(int idx, int idy, int c0, int c1, C_t4 local_C[8][2], hls::stream<C_t4> &fifo_C_drain_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L1_out_m1_4(int idx, int idy, hls::stream<C_t4> &fifo_C_drain_in, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<float> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  C_t4 local_C[8][2];
  ...
  for (ap_uint<3> c0 = 0; c0 <= 3; c0 += 1)
    for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1) {
      ...
      // io_L3
      // io_L2
      C_drain_IO_L1_out_intra_trans_m1_4(
        /* module id */ idx, 
        /* module id */ idy, 
        /* host iter */ c0, 
        /* host iter */ c1, 
      ...
      C_drain_IO_L1_out_inter_trans_m1_4(
        /* module id */ idx, 
        /* module id */ idy, 
        /* host iter */ c0, 
        /* host iter */ c1, 
...
/* Module Definition */
void C_drain_IO_L1_out_wrapper_m1_4(int idx, int idy, hls::stream<C_t4> &fifo_C_drain_in, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<float> &fifo_C_drain_local_in)
 {
  C_drain_IO_L1_out_m1_4(
    /* module id */ idx, 
    /* module id */ idy, 
    /* fifo */ fifo_C_drain_in, 
    /* fifo */ fifo_C_drain_out, 
...
/* Module Definition */
void C_drain_IO_L1_out_boundary_m1_4(int idx, int idy, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<float> &fifo_C_drain_local_in) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  C_t4 local_C[8][2];
  ...
  for (ap_uint<3> c0 = 0; c0 <= 3; c0 += 1)
    for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1) {
      ...
      C_drain_IO_L1_out_inter_trans_boundary_m1_4(
        /* module id */ idx, 
        /* module id */ idy, 
        /* host iter */ c0, 
        /* host iter */ c1, 
...
/* Module Definition */
void C_drain_IO_L1_out_boundary_wrapper_m1_4(int idx, int idy, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<float> &fifo_C_drain_local_in)
 {
  C_drain_IO_L1_out_boundary_m1_4(
    /* module id */ idx, 
    /* module id */ idy, 
    /* fifo */ fifo_C_drain_out, 
    /* fifo */ fifo_C_drain_local_in);
...
/* Module Definition */
void C_drain_IO_L2_out_m1_4(int idx, hls::stream<C_t4> &fifo_C_drain_in, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<C_t4> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L2_out_boundary_m1_4(int idx, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<C_t4> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L3_out_m1_4(hls::stream<C_t4> &fifo_C_drain_out, hls::stream<C_t4> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L3_out_serialize_m1_4(C_t16 *C, hls::stream<C_t4> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
void kernel_m1_4(A_t16 *A, B_t16 *B, C_t16 *C)
{
#pragma HLS DATAFLOW
  ...
  /* Module Call */
  C_drain_IO_L1_out_boundary_wrapper_m1_4(
    /* module id */ 0,
    /* module id */ 1,
    /* fifo */ fifo_C_drain_C_drain_IO_L1_out_0_1,
    /* fifo */ fifo_C_drain_PE_1_0
  ...
  /* Module Call */
  C_drain_IO_L1_out_wrapper_m1_4(
    /* module id */ 0,
    /* module id */ 0,
    /* fifo */ fifo_C_drain_C_drain_IO_L1_out_0_1,
    /* fifo */ fifo_C_drain_C_drain_IO_L1_out_0_0,
  ...
  /* Module Call */
  C_drain_IO_L2_out_boundary_m1_4(
    /* module id */ 1,
    /* fifo */ fifo_C_drain_C_drain_IO_L2_out_1,
    /* fifo */ fifo_C_drain_C_drain_IO_L1_out_1_0
  );
  ...
  /* Module Call */
  C_drain_IO_L3_out_serialize_m1_4(
    /* array */ C,
    /* fifo */ fifo_C_drain_C_drain_IO_L3_out_serialize
  );
  /* Module Call */
...
/* Module Definition */
void A_IO_L3_in_m1_5(hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void A_IO_L3_in_serialize_m1_5(A_t16 *A, hls::stream<A_t16> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void A_IO_L2_in_intra_trans_m1_5(int idx, int c0, int c1, int c2, A_t16 local_A[8][1], hls::stream<A_t2> &fifo_A_local_out, bool intra_trans_en) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  A_t2 data_split[8];
...
/* Module Definition */
void A_IO_L2_in_inter_trans_m1_5(int idx, int c0, int c1, int c2, A_t16 local_A[8][1], hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_out, bool inter_trans_en) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void A_IO_L2_in_inter_trans_boundary_m1_5(int idx, int c0, int c1, int c2, A_t16 local_A[8][1], hls::stream<A_t16> &fifo_A_in, bool inter_trans_en) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void A_IO_L2_in_m1_5(int idx, hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_out, hls::stream<A_t2> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  A_t16 local_A_ping[8][1];
...
/* Module Definition */
void A_IO_L2_in_boundary_m1_5(int idx, hls::stream<A_t16> &fifo_A_in, hls::stream<A_t2> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  A_t16 local_A_ping[8][1];
    ...
    for (ap_uint<3> c0 = 0; c0 <= 3; c0 += 1)
      for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1)
        for (ap_uint<3> c2 = 0; c2 <= 3; c2 += 1) {
          ...
          {
            if (arb == 0) {
              A_IO_L2_in_inter_trans_boundary_m1_5(
                /* module id */ idx, 
                /* host iter */ c0, 
                /* host iter */ c1, 
                /* host iter */ c2, 
...
/* Module Definition */
void B_IO_L3_in_m1_5(hls::stream<B_t16> &fifo_B_in, hls::stream<B_t16> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L3_in_serialize_m1_5(B_t16 *B, hls::stream<B_t16> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L2_in_intra_trans_m1_5(int idx, int c0, int c1, int c2, B_t16 local_B[8][1], hls::stream<B_t2> &fifo_B_local_out, bool intra_trans_en) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  B_t2 data_split[8];
...
/* Module Definition */
void B_IO_L2_in_inter_trans_m1_5(int idx, int c0, int c1, int c2, B_t16 local_B[8][1], hls::stream<B_t16> &fifo_B_in, hls::stream<B_t16> &fifo_B_out, bool inter_trans_en) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L2_in_inter_trans_boundary_m1_5(int idx, int c0, int c1, int c2, B_t16 local_B[8][1], hls::stream<B_t16> &fifo_B_in, bool inter_trans_en) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L2_in_m1_5(int idx, hls::stream<B_t16> &fifo_B_in, hls::stream<B_t16> &fifo_B_out, hls::stream<B_t2> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  B_t16 local_B_ping[8][1];
...
/* Module Definition */
void B_IO_L2_in_boundary_m1_5(int idx, hls::stream<B_t16> &fifo_B_in, hls::stream<B_t2> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  B_t16 local_B_ping[8][1];
    ...
    for (ap_uint<3> c0 = 0; c0 <= 3; c0 += 1)
      for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1)
        for (ap_uint<3> c2 = 0; c2 <= 3; c2 += 1) {
          ...
          {
            if (arb == 0) {
              B_IO_L2_in_inter_trans_boundary_m1_5(
                /* module id */ idx, 
                /* host iter */ c0, 
                /* host iter */ c1, 
                /* host iter */ c2, 
...
/* Module Definition */
void PE_m1_5(int idx, int idy, hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, hls::stream<float> &fifo_C_drain_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  A_t1 local_A[1][2];
...
/* Module Definition */
void PE_wrapper_m1_5(int idx, int idy, hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, hls::stream<float> &fifo_C_drain_out)
 {
  PE_m1_5(
    /* module id */ idx, 
    /* module id */ idy, 
...
/* Module Definition */
void A_PE_dummy_in_m1_5(int idx, int idy, hls::stream<A_t2> &fifo_A_in) {
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
...
/* Module Definition */
void B_PE_dummy_in_m1_5(int idx, int idy, hls::stream<B_t2> &fifo_B_in) {
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L1_out_intra_trans_m1_5(int idx, int idy, int c0, int c1, C_t4 local_C[8][2], hls::stream<float> &fifo_C_drain_local_in) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  ap_uint<32> data_split[4];
...
/* Module Definition */
void C_drain_IO_L1_out_inter_trans_m1_5(int idx, int idy, int c0, int c1, C_t4 local_C[8][2], hls::stream<C_t4> &fifo_C_drain_in, hls::stream<C_t4> &fifo_C_drain_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L1_out_inter_trans_boundary_m1_5(int idx, int idy, int c0, int c1, C_t4 local_C[8][2], hls::stream<C_t4> &fifo_C_drain_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L1_out_m1_5(int idx, int idy, hls::stream<C_t4> &fifo_C_drain_in, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<float> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  C_t4 local_C[8][2];
  ...
  for (ap_uint<3> c0 = 0; c0 <= 3; c0 += 1)
    for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1) {
      ...
      // io_L3
      // io_L2
      C_drain_IO_L1_out_intra_trans_m1_5(
        /* module id */ idx, 
        /* module id */ idy, 
        /* host iter */ c0, 
        /* host iter */ c1, 
      ...
      C_drain_IO_L1_out_inter_trans_m1_5(
        /* module id */ idx, 
        /* module id */ idy, 
        /* host iter */ c0, 
        /* host iter */ c1, 
...
/* Module Definition */
void C_drain_IO_L1_out_wrapper_m1_5(int idx, int idy, hls::stream<C_t4> &fifo_C_drain_in, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<float> &fifo_C_drain_local_in)
 {
  C_drain_IO_L1_out_m1_5(
    /* module id */ idx, 
    /* module id */ idy, 
    /* fifo */ fifo_C_drain_in, 
    /* fifo */ fifo_C_drain_out, 
...
/* Module Definition */
void C_drain_IO_L1_out_boundary_m1_5(int idx, int idy, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<float> &fifo_C_drain_local_in) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  C_t4 local_C[8][2];
  ...
  for (ap_uint<3> c0 = 0; c0 <= 3; c0 += 1)
    for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1) {
      ...
      C_drain_IO_L1_out_inter_trans_boundary_m1_5(
        /* module id */ idx, 
        /* module id */ idy, 
        /* host iter */ c0, 
        /* host iter */ c1, 
...
/* Module Definition */
void C_drain_IO_L1_out_boundary_wrapper_m1_5(int idx, int idy, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<float> &fifo_C_drain_local_in)
 {
  C_drain_IO_L1_out_boundary_m1_5(
    /* module id */ idx, 
    /* module id */ idy, 
    /* fifo */ fifo_C_drain_out, 
    /* fifo */ fifo_C_drain_local_in);
...
/* Module Definition */
void C_drain_IO_L2_out_m1_5(int idx, hls::stream<C_t4> &fifo_C_drain_in, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<C_t4> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L2_out_boundary_m1_5(int idx, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<C_t4> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L3_out_m1_5(hls::stream<C_t4> &fifo_C_drain_out, hls::stream<C_t4> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L3_out_serialize_m1_5(C_t16 *C, hls::stream<C_t4> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
void kernel_m1_5(A_t16 *A, B_t16 *B, C_t16 *C)
{
#pragma HLS DATAFLOW
  ...
  /* Module Call */
  C_drain_IO_L1_out_boundary_wrapper_m1_5(
    /* module id */ 0,
    /* module id */ 1,
    /* fifo */ fifo_C_drain_C_drain_IO_L1_out_0_1,
    /* fifo */ fifo_C_drain_PE_1_0
  ...
  /* Module Call */
  C_drain_IO_L1_out_wrapper_m1_5(
    /* module id */ 0,
    /* module id */ 0,
    /* fifo */ fifo_C_drain_C_drain_IO_L1_out_0_1,
    /* fifo */ fifo_C_drain_C_drain_IO_L1_out_0_0,
  ...
  /* Module Call */
  C_drain_IO_L2_out_boundary_m1_5(
    /* module id */ 1,
    /* fifo */ fifo_C_drain_C_drain_IO_L2_out_1,
    /* fifo */ fifo_C_drain_C_drain_IO_L1_out_1_0
  );
  ...
  /* Module Call */
  C_drain_IO_L3_out_serialize_m1_5(
    /* array */ C,
    /* fifo */ fifo_C_drain_C_drain_IO_L3_out_serialize
  );
  /* Module Call */
...
void top(A_t16 *A, B_t16 *B, C_t16 *C){
    ...
    kernel_m1_1(C_temp3, C_temp3, C_temp6);
    kernel_c0(C_temp4, C_temp5);

    kernel_m1_2(C_temp5, C_temp5, C_temp7);
    kernel_m2_1(C_temp6, C_temp6, C_temp8);
    kernel_m1_3(C_temp7, C_temp7, C_temp10);
    kernel_c1(C_temp8, C_temp9);

    kernel_m1_4(C_temp9, C_temp9, C_temp11);
    kernel_m2_2(C_temp10, C_temp10, C_temp12);
    kernel_m1_5(C_temp11, C_temp11, C_temp14);
