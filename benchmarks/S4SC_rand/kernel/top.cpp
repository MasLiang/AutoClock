#include "top.h"
/* Module Definition */
void A_IO_L3_in_m1(hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_local_out) {
...
/* Module Definition */
void A_IO_L3_in_serialize_m1(A_t16 *A, hls::stream<A_t16> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void A_IO_L2_in_m1(int idx, hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_out, hls::stream<A_t2> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
...
/* Module Definition */
void A_IO_L2_in_boundary_m1(int idx, hls::stream<A_t16> &fifo_A_in, hls::stream<A_t2> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  A_t16 local_A_ping[8][1];
    ...
    for (ap_uint<3> c0 = 0; c0 <= 3; c0 += 1)
      for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1)
        for (ap_uint<3> c2 = 0; c2 <= 3; c2 += 1) {
          ...
          {
            if (arb == 0) {
              A_IO_L2_in_inter_trans_boundary_m1(
                /* module id */ idx, 
                /* host iter */ c0, 
                /* host iter */ c1, 
                /* host iter */ c2, 
...
/* Module Definition */
void B_IO_L3_in_m1(hls::stream<B_t16> &fifo_B_in, hls::stream<B_t16> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L3_in_serialize_m1(B_t16 *B, hls::stream<B_t16> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L2_in_m1(int idx, hls::stream<B_t16> &fifo_B_in, hls::stream<B_t16> &fifo_B_out, hls::stream<B_t2> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
...
/* Module Definition */
void B_IO_L2_in_boundary_m1(int idx, hls::stream<B_t16> &fifo_B_in, hls::stream<B_t2> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  B_t16 local_B_ping[8][1];
    ...
    for (ap_uint<3> c0 = 0; c0 <= 3; c0 += 1)
      for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1)
        for (ap_uint<3> c2 = 0; c2 <= 3; c2 += 1) {
          ...
          {
            if (arb == 0) {
              B_IO_L2_in_inter_trans_boundary_m1(
                /* module id */ idx, 
                /* host iter */ c0, 
                /* host iter */ c1, 
                /* host iter */ c2, 
...
/* Module Definition */
void PE_m1(int idx, int idy, hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, hls::stream<float> &fifo_C_drain_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
...
/* Module Definition */
void A_PE_dummy_in_m1(int idx, int idy, hls::stream<A_t2> &fifo_A_in) {
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
...
/* Module Definition */
void B_PE_dummy_in_m1(int idx, int idy, hls::stream<B_t2> &fifo_B_in) {
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L1_out_m1(int idx, int idy, hls::stream<C_t4> &fifo_C_drain_in, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<float> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  C_t4 local_C[8][2];
  ...
  for (ap_uint<3> c0 = 0; c0 <= 3; c0 += 1)
    for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1) {
      ...
      // io_L3
      // io_L2
      C_drain_IO_L1_out_intra_trans_m1(
        /* module id */ idx, 
        /* module id */ idy, 
        /* host iter */ c0, 
        /* host iter */ c1, 
      ...
      C_drain_IO_L1_out_inter_trans_m1(
        /* module id */ idx, 
        /* module id */ idy, 
        /* host iter */ c0, 
        /* host iter */ c1, 
...
/* Module Definition */
void C_drain_IO_L1_out_boundary_m1(int idx, int idy, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<float> &fifo_C_drain_local_in) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  C_t4 local_C[8][2];
  ...
  for (ap_uint<3> c0 = 0; c0 <= 3; c0 += 1)
    for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1) {
      ...
      C_drain_IO_L1_out_inter_trans_boundary_m1(
        /* module id */ idx, 
        /* module id */ idy, 
        /* host iter */ c0, 
        /* host iter */ c1, 
...
/* Module Definition */
void C_drain_IO_L2_out_m1(int idx, hls::stream<C_t4> &fifo_C_drain_in, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<C_t4> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L2_out_boundary_m1(int idx, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<C_t4> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L3_out_m1(hls::stream<C_t4> &fifo_C_drain_out, hls::stream<C_t4> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L3_out_serialize_m1(C_t16 *C, hls::stream<C_t4> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
#pragma HLS DATAFLOW
  ...
  /* Module Call */
  C_drain_IO_L1_out_boundary_wrapper_m1(
    /* module id */ 0,
    /* module id */ 1,
  ...
  /* Module Call */
  C_drain_IO_L3_out_serialize_m1(
    /* array */ C,
    /* fifo */ fifo_C_drain_C_drain_IO_L3_out_serialize
  );
  /* Module Call */
...
/* Module Definition */
void A_IO_L3_in_m2(hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void A_IO_L3_in_serialize_m2(A_t16 *A, hls::stream<A_t16> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void A_IO_L2_in_m2(int idx, hls::stream<A_t16> &fifo_A_in, hls::stream<A_t16> &fifo_A_out, hls::stream<A_t2> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
...
/* Module Definition */
void A_IO_L2_in_boundary_m2(int idx, hls::stream<A_t16> &fifo_A_in, hls::stream<A_t2> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  A_t16 local_A_ping[4][1];
    ...
    for (ap_uint<3> c0 = 0; c0 <= 3; c0 += 1)
      for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1)
        for (ap_uint<3> c2 = 0; c2 <= 3; c2 += 1) {
          ...
          {
            if (arb == 0) {
              A_IO_L2_in_inter_trans_boundary_m2(
                /* module id */ idx, 
                /* host iter */ c0, 
                /* host iter */ c1, 
                /* host iter */ c2, 
...
/* Module Definition */
void B_IO_L3_in_m2(hls::stream<B_t16> &fifo_B_in, hls::stream<B_t16> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L3_in_serialize_m2(B_t16 *B, hls::stream<B_t16> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L2_in_m2(int idx, hls::stream<B_t16> &fifo_B_in, hls::stream<B_t16> &fifo_B_out, hls::stream<B_t2> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
...
/* Module Definition */
void B_IO_L2_in_boundary_m2(int idx, hls::stream<B_t16> &fifo_B_in, hls::stream<B_t2> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  B_t16 local_B_ping[4][1];
    ...
    for (ap_uint<3> c0 = 0; c0 <= 3; c0 += 1)
      for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1)
        for (ap_uint<3> c2 = 0; c2 <= 3; c2 += 1) {
          ...
          {
            if (arb == 0) {
              B_IO_L2_in_inter_trans_boundary_m2(
                /* module id */ idx, 
                /* host iter */ c0, 
                /* host iter */ c1, 
                /* host iter */ c2, 
...
/* Module Definition */
void PE_m2(int idx, int idy, hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, hls::stream<float> &fifo_C_drain_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  A_t1 local_A[1][2];
...
/* Module Definition */
void A_PE_dummy_in_m2(int idx, int idy, hls::stream<A_t2> &fifo_A_in) {
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
...
/* Module Definition */
void B_PE_dummy_in_m2(int idx, int idy, hls::stream<B_t2> &fifo_B_in) {
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L1_out_m2(int idx, int idy, hls::stream<C_t4> &fifo_C_drain_in, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<float> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  C_t4 local_C[4][1];
  ...
  for (ap_uint<3> c0 = 0; c0 <= 3; c0 += 1)
    for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1) {
      ...
      // io_L3
      // io_L2
      C_drain_IO_L1_out_intra_trans_m2(
        /* module id */ idx, 
        /* module id */ idy, 
        /* host iter */ c0, 
        /* host iter */ c1, 
      ...
      C_drain_IO_L1_out_inter_trans_m2(
        /* module id */ idx, 
        /* module id */ idy, 
        /* host iter */ c0, 
        /* host iter */ c1, 
...
/* Module Definition */
void C_drain_IO_L1_out_boundary_m2(int idx, int idy, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<float> &fifo_C_drain_local_in) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  C_t4 local_C[4][1];
  ...
  for (ap_uint<3> c0 = 0; c0 <= 3; c0 += 1)
    for (ap_uint<3> c1 = 0; c1 <= 3; c1 += 1) {
      ...
      C_drain_IO_L1_out_inter_trans_boundary_m2(
        /* module id */ idx, 
        /* module id */ idy, 
        /* host iter */ c0, 
        /* host iter */ c1, 
...
/* Module Definition */
void C_drain_IO_L2_out_m2(int idx, hls::stream<C_t4> &fifo_C_drain_in, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<C_t4> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L2_out_boundary_m2(int idx, hls::stream<C_t4> &fifo_C_drain_out, hls::stream<C_t4> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L3_out_m2(hls::stream<C_t4> &fifo_C_drain_out, hls::stream<C_t4> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L3_out_serialize_m2(C_t16 *C, hls::stream<C_t4> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
#pragma HLS DATAFLOW
  ...
  /* Module Call */
  C_drain_IO_L1_out_boundary_wrapper_m2(
    /* module id */ 0,
    /* module id */ 3,
  ...
  /* Module Call */
  C_drain_IO_L3_out_serialize_m2(
    /* array */ C,
    /* fifo */ fifo_C_drain_C_drain_IO_L3_out_serialize
  );
  /* Module Call */
...
void kernel_c1_0(C_t16 *A, C_t16 *B)
{
  int i, j, k;
  C_t16 mean[16];
  C_t16 A_temp[256];
...
void kernel_c1_1(C_t16 *A, C_t16 *B)
{
  int i, j, k;
  C_t16 mean[16];
  C_t16 A_temp[256];
...
void kernel_c1_3(C_t16 *A, C_t16 *B)
{
  int i, j, k;
  C_t16 mean[16];
  C_t16 A_temp[256];
...
void kernel_c1_2(C_t16 *A, C_t16 *B)
{
  int i, j, k;
  C_t16 mean[16];
  C_t16 A_temp[256];
...
void top(A_t16 *A, B_t16 *B, C_t16 *C){
    ...
    C_t16 C_temp10[256];
    C_t16 C_temp11[256];
    kernel_m1_0(A, B, C_temp1);
    kernel_c1_0(C_temp1, C_temp2);
    kernel_m2_0(C_temp2, C_temp2, C_temp3);
    kernel_m1_1(C_temp3, C_temp3, C_temp4);
    kernel_c1_1(C_temp4, C_temp5);
    kernel_m2_1(C_temp5, C_temp5, C_temp6);
    kernel_m1_2(C_temp6, C_temp6, C_temp7);
    kernel_c1_2(C_temp7, C_temp8);
    kernel_m2_2(C_temp8, C_temp8, C_temp9);
    kernel_m1_3(C_temp9, C_temp9, C_temp10);
    kernel_c1_3(C_temp10, C_temp11);
    kernel_m2_3(C_temp11, C_temp11, C);
}
}
