def gen_mmcme3_file(module_name, factors):
    ...
    lst_inst.append("mmcme3_adv_inst(")
    ...
    lst_inst.append("   .CLKIN1                 (clk_in0),")
    if(clkin_num>1):
        lst_inst.append("   .CLKIN2                 (clk_in1),")
    else:
...
def gen_mmcme3_inst(module_name, factors):
    gen_mmcme3_file(module_name, factors)
    clkout_num = factors[1]
    clkin_num = 1
