def gen_plle3_file(module_name, factors):
    ...
    lst_inst.append("plle3_adv_inst(")
...
def gen_plle3_inst(module_name, factors):
    gen_plle3_file(module_name, factors)
    clkout_num = factors[1]
    clkin_num = 1
